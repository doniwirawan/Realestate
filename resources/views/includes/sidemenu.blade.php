...
<div class="box-collapse">
    ...
    <div class="box-collapse-wrap form">
        <form action="{{url('/search-form')}}" method="POST" class="form-a">
            {{ @csrf_field() }}
            <div class="row">
                <div class="col-md-12 mb-2">
                    <div class="form-group">
                        <label for="status">Status</label>
                        <select class="form-control form-control-lg form-control-a" id="status" name="status" required>
                ...
                <div class="col-md-12 mb-2">
                    <div class="form-group">
                        <label for="prices">Max Price</label>
                        <select class="form-control form-control-lg form-control-a" id="prices" name="price" required>
                            <option value="" selected disabled hidden>Choose here</option>
